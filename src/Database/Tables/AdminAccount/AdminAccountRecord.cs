...
namespace SecretGarden.OrderSystem.Database.Tables.AdminAccount{
	class AdminAccountRecord : Record, IRecord{
		...
		public string firstName{
			get=>rd_first_name;
			set{
				tableWrapper.update_field("first_name",value,DBWrapper.prepare_datatypes.STRING,$"admin_id={primaryKey}");
		...
		public string lastName{
			get=>rd_last_name;
			set{
				tableWrapper.update_field("last_name",value,DBWrapper.prepare_datatypes.STRING,$"admin_id={primaryKey}");
		...
		public string passwordSalt{
			...
			set{
				tableWrapper.update_field("password_salt",value,DBWrapper.prepare_datatypes.STRING,$"admin_id={primaryKey}");
		...
		public string passwordHash{
			...
			set{
				tableWrapper.update_field("password_hash",value,DBWrapper.prepare_datatypes.STRING,$"admin_id={primaryKey}");
		...
		public Datetime establishDate{
			...
			set{
				tableWrapper.update_field("establish_date",value.sqlFormatDate,DBWrapper.prepare_datatypes.STRING,$"admin_id={primaryKey}");
				this.rd_establish_date = value;
			}
		}
		public DBTable tableWrapper{get=>table_wrapper;}
